...
{
	union {
		BAKERY_REQUEST submit_request_1_arg;
		int get_ticket_number_1_arg;
		int get_queue_position_1_arg;
	} argument;
	char *result;
	...
	case SUBMIT_REQUEST:
		_xdr_argument = (xdrproc_t) xdr_BAKERY_REQUEST;
		_xdr_result = (xdrproc_t) xdr_BAKERY_RESPONSE;
		local = (char *(*)(char *, struct svc_req *)) submit_request_1_svc;
		break;
	...
	case GET_QUEUE_POSITION:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) get_queue_position_1_svc;
		break;
